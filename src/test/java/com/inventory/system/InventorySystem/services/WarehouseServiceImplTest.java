...
public class WarehouseServiceImplTest {
    ...
    public void getWarehouseById() {
        ...
        when(globalMapper.warehouseToWarehouseDto(mockData.getWarehouse())).thenReturn(mockDtoData.getWarehouseDto());
        assertEquals(mockDtoData.getWarehouseDto(), warehouseService.getWarehouseById(mockDtoData.getWarehouseDto()));
    }
    ...
    public void testGlobalException() {
        ...
        assertThrows(GlobalException.class, () -> warehouseService.getWarehouseById(mockDtoData.getWarehouseDto()));
    }
}
